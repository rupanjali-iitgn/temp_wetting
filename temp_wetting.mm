...
<hook EQUATION="\Delta N_{sol} = -\frac{\partial{\Delta \mu}}{\partial \mu_{sol}}\\&#xa;\frac{\partial{\Delta \mu}}{\partial \mu_{sol}} = -\int_0^1 d\lambda \int_{r_1} dr_1 \chi (r_1) v_{\Psi} (r_1,r) " NAME="plugins/latex/LatexNodeHook.properties"/>
</node>
...
<hook EQUATION="(\frac{d\Delta \mu}{dT})_{CW} = (\frac{\mu_{sol}}{T}-\frac{d\mu_{sol}}{dT})\int_0^1 d\lambda \int_{r_1} dr_{1} \chi (r_1) v_{\Psi}" NAME="plugins/latex/LatexNodeHook.properties"/>
</node>
...
<hook EQUATION="\Delta \mu = A(\gamma_{sl} - \gamma_{sv} - \gamma_{lv})" NAME="plugins/latex/LatexNodeHook.properties"/>
</node>
</node>
</node>
